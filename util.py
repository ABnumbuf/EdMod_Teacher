...
sg.LOOK_AND_FEEL_TABLE['MyTheme'] = {
            'BACKGROUND': '#333232',
            'TEXT': '#FFFFEB',
            'INPUT': '#3E3D3D',
            'SCROLL': '#333232',
            'TEXT_INPUT': '#FFCE5C',
            'BUTTON': ('#1F1E1E', '#FFDA85'),
            'PROGRESS': ('#1F1E1E', '#FFDA85'),
            'BORDER': 0,
            'SLIDER_DEPTH': 0,
            'PROGRESS_DEPTH': 0}

sg.theme('MyTheme') #sg.theme_list()[randint(1,153)]
global myfont 
myfont = 'Arial Greek' #sg.Text.fonts_installed_list()[randint(1,223)]
sg.set_options(font=(myfont, 12))
